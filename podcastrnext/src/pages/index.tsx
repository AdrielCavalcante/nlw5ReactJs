/* Para criar um next.js:  npx create-next-app (NOME DO APP)
   Usando SSG
   Feito durante o NLW 5 de React.js
   Adicionar PWA */
    ...
    <section className={styles.latestEpisodes}>
      ...
      <ul>
        {latestEpisodes.map((episode, index) =>{
          return (
            <li key={episode.id} > {/*tipo uma chave primaria*/}
              <Image  
                width={192} 
                height={192} 
...
export const getStaticProps : GetStaticProps = async () => { //Agora, tipado
